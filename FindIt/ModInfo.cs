...
namespace FindIt
{
    public class ModInfo : IUserMod
    {
        ...
        public const double updateNoticeDate = 20210507;
        public const string updateNotice =

            "- Network assets generated by following mods will have a blue steam icon on their\n" +
            "  thumbnails, hover your mouse over the icon and it will show the name of the mod:\n\n" +
            "  Network Extension 2, Extra Train Station Tracks, One-Way Train Tracks\n" +
            "  These assets will no longer be considered as vanilla assets by Find It 2\n\n" + 

            "- Find It 2 will also show DLC icons on vanilla panels\n\n" +

            "- Add an option in mod settings to hide Find It 2's extra UI on vanilla panels\n" +
            "  Including: custom tag icons, steam icons, and DLC icons\n\n" +
