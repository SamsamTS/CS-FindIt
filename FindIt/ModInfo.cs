...
namespace FindIt
{
    public class ModInfo : IUserMod
    {
        ...
        public const float updateNoticeDate = 20200915.0f;
        public const string updateNotice =
            "- Add update notice pop-up(this thing). You can disable future update\n" +
            " notice in mod settings.\n\n" +
            "- Sub-buildings are now accessible via the extra filters panel\n\n" +
            "- (In Quick Menu) Optionally use light background color for the main\n" +
            " panel. Easier to see some darker assets like ruin decals and street\n" +
            " light poles, but harder to see brighter assets.\n\n" +
            "- Add new prop filter tabs for props generated by Elektrix's Tree\n" +
            " and Vehicle Props mod(TVP). Also require the Tree & Vehicle Props Patch\n" +
            " mod";
