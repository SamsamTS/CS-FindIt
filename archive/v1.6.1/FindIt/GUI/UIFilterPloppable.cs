...
namespace FindIt.GUI
{
    public class UIFilterPloppable : UIPanel
    {
        ...
        public static Category GetCategory(ItemClass itemClass)
        {
            ...
            if (itemClass.m_service == ItemClass.Service.PlayerIndustry) return Category.Garbage;
            if (itemClass.m_service == ItemClass.Service.Fishing) return Category.Garbage;
            ...
            if (itemClass.m_service == ItemClass.Service.Disaster) return Category.FireDepartment;
            ...
            if (itemClass.m_service == ItemClass.Service.PlayerEducation) return Category.Education;
            if (itemClass.m_service == ItemClass.Service.Museums) return Category.Education;
            if (itemClass.m_service == ItemClass.Service.VarsitySports) return Category.Education;
